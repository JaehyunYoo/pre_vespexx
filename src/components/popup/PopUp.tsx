...
const PopUp = () => {
  ...
  return (
    <>
      {showPopup && (
        <>
          <div className="fixed top-0 left-0 w-full h-full z-40 flex items-center justify-center bg-black/60">
            <div className="w-full lg:max-w-[650px] sm:max-w[400px] xs:max-w-[320px] lg:mb-0 xs:mb-2 relative">
              ...
              >
                {popUpDate.map((item) => {
                  const src = isMobile ? item.mobile : item.desktop;
                  return (
                    <SwiperSlide
                      key={item.id}
